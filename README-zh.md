...
用于应用内购买的轻量级且易用的iOS库([Swift Version](https://github.com/chenxing640/DYFStore))。

`DYFStoreKit`使用代码块和[通知](#通知)包装`StoreKit`，提供[收据验证](#收据验证)和[交易持久化](#交易持久化)。
...
引用验证程序概述如下。有关更多信息，请查看 [wiki](https://github.com/chenxing640/DYFStoreKit/wiki/Receipt-verification).
...
如需了解更多，请克隆此项目（`git clone https://github.com/chenxing640/DYFStoreKit.git`）到本地目录。
